...
Ожидаемый результат: Тест успешно проходящий проверку заголовк:
...
Решение:
1) Общее количество возможных вариантов при подбрасывании монеты 3 раза = 8;
2) Количество вариантов, когда выпадает 2 орла = 3;
3) Вероятность события равна отношению числа благоприятных исходов к общему числу возможных исходов: 3/8*100% = 37,5%
